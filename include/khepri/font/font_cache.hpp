...
public:
    ...
    /// Constructs a font cache by moving from another font cache
    FontCache(FontCache&& cache) noexcept;

    /// Moves another font cache into this object
    FontCache& operator=(FontCache&& cache) noexcept;
